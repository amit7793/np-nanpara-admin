...
@section('content')
    ...
    <div class="xl:px-[4rem] px-[10px] py-[1rem]">
        <h2 class="font-bold text-[32px] leading-[40px] text-[#000000]">Birth Certificate Verification Request</h2>
        <div class="border border-[#A0A0A0] rounded-[15px] py-[20px] mt-6">
            <table id="trades-table" class="display">
                ...
                <tbody>
                    @foreach ($birthcertificate as $key => $data)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            ...
                            @endif
                            <td><a href="{{ route('birth.certificate.view', ['id' => $data->id]) }}">
