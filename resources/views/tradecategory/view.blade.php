    ...
    <div class="border border-[#B1B6C6] rounded-[20px] mt-10    lg:px-[4rem] px-[10px]  ">
        <div class=" border-b border-[#B1B6C6] pb-[100px]">
            ...
            <div class="lg:flex lg:flex-row lg:items-center justify-between gap-4 flex flex-col md:flex md:flex-row">
                <h2 class=" font-bold text-[29px] lg:text-[32px] leading-[40px] text-left text-[#000000]">Trade License Approval
                </h2>
                            ...
                            <div>
                                ...
                                <div class="lg:flex md:flex gap-4 items-center pt-3">
                                    ...
                                    <div>
                                        ...
                                        @endif
                                        <p class=" font-medium  text-[14px] text-[#CFC7C0] leading-[22px]">{{$trades["ownership_id_proof"] ?? "NA"}}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="lg:flex md:flex gap-4 items-center pt-3">
                                        ...
                                        <div>
                                            ...
                                            @endif
                                            <p class=" font-medium  text-[14px] text-[#CFC7C0] leading-[22px]">{{$trades["ownership_proof"] ?? "NA"}}</p>
                            ...
                            <div>
                                ...
                                <div class="lg:flex md:flex  gap-4 items-center pt-3">
                                    ...
                                    <div>
                                        ...
                                        @endif
                                        <p class=" font-medium  text-[14px] text-[#CFC7C0] leading-[22px]">{{$trades['ownership'] ?? "NA"}}
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="px-[30px] mt-4">
                ...
                <button id="approveButton" class="bg-green-500 text-white py-2 px-4 rounded" onclick="showApproveAlert({{ $trades['id']  }},1)">Approve</button>
                <button id="rejectButton" class="bg-red-500 text-white py-2 px-4 rounded" onclick="showApproveAlert({{ $trades['id'] }},2)">Reject</button>
            </div>
